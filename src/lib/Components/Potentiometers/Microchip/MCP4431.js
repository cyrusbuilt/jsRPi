...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4431.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4431 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4431 class wit the I2C device that
     * is the connection to the MCP4431, whether the address pin A0 is high or
