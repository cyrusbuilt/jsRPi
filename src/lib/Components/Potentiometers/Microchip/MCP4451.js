...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4451.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4451 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4452 class wit the I2C device that
     * is the connection to the MCP4451, whether the address pin A0 is high or
