...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4532.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4532 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4532 class wit the I2C device that
     * is the connection to the MCP4532, whether the address pin A0 is high or
