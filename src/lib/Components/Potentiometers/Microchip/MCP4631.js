 ...
 */
class MCP4631 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4631 class wit the I2C device that
     * is the connection to the MCP4631, whether the address pin A0 is high or
     ...
     * @constructor
     */
    constructor(device = null, pinA0 = false, pinA1 = false, pinA2 = false,
                channel = MicrochipPotChannel.None, initialValue = 0) {
        super(device, pinA0, pinA1, pinA2, channel,
