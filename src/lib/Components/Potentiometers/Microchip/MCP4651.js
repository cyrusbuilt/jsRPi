...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4651.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4651 extends MicrochipPotentiometerBase {
    /**
     ...
     * @constructor
     */
    constructor(device = null, pinA0 = false, pinA1 = false, pinA2 = false, channel = MicrochipPotChannel.None, initialValue = 0) {
