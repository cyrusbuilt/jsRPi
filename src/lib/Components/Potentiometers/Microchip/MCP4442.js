...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4442.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4442 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4442 class wit the I2C device that
     * is the connection to the MCP4442, whether the address pin A0 is high or
