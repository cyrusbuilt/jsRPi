...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4552.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4552 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4552 class wit the I2C device that
     * is the connection to the MCP4552, whether the address pin A0 is high or
