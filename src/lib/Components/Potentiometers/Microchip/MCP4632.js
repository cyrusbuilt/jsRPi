...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4632.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4632 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4632 class wit the I2C device that
     * is the connection to the MCP4632, whether the address pin A0 is high or
     ...
     * @param {Number} initialValue The value for devices which are not capable of non-volatile wipers.
     * @throws {ArgumentNullException} if 'device' is null.
     * @throws {IOException} if unable to open the I2C bus.
     * @constructor
     */
    constructor(device = null, pinA0 = false, pinA1 = false,
                channel = MicrochipPotChannel.None, initialValue = 0) {
