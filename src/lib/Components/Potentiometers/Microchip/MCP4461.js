...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4461.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4461 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4461 class wit the I2C device that
     * is the connection to the MCP4461, whether the address pin A0 is high or
