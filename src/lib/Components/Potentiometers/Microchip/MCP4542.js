...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4542.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4542 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4542 class wit the I2C device that
     * is the connection to the MCP4542, whether the address pin A0 is high or
