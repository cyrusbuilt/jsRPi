...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4531.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4531 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4531 class wit the I2C device that
     * is the connection to the MCP4531, whether the address pin A0 is high or
     ...
     * @constructor
     */
    constructor(device = null, pinA0 = false, pinA1 = false, initialValue = 0) {
