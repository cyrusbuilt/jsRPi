...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4561.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4561 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4561 class wit the I2C device that
     * is the connection to the MCP4561, whether the address pin A0 is high or
     ...
     * @constructor
     */
    constructor(device = null, pinA0 = false, nonVolatileMode = MicrochipPotNonVolatileMode.VolatileAndNonVolatile) {
