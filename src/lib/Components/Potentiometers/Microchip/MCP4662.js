...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4662.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4662 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4662 class wit the I2C device that
     * is the connection to the MCP4662, whether the address pin A0 is high or
     ...
     * @constructor
     */
    constructor(device = null, pinA0 = false, pinA1 = false, channel = MicrochipPotChannel.None,
