...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4551.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4551 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4551 class wit the I2C device that
     * is the connection to the MCP4551, whether the address pin A0 is high or
