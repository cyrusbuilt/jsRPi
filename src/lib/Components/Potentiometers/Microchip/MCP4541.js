...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4541.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4541 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4541 class wit the I2C device that
     * is the connection to the MCP4541, whether the address pin A0 is high or
