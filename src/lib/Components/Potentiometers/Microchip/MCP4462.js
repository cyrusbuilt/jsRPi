...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4462.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4462 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4462 class wit the I2C device that
     * is the connection to the MCP4462, whether the address pin A0 is high or
