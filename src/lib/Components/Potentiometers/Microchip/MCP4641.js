...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4641.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4641 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4641 class wit the I2C device that
     * is the connection to the MCP4641, whether the address pin A0 is high or
    ...
    constructor(device = null, pinA0 = false, pinA1 = false, pinA2 = false, channel = MicrochipPotChannel.None,
                nonVolatileMode = MicrochipPotNonVolatileMode.VolatileAndNonVolatile) {
        super(device, pinA0, pinA1, pinA2, channel, nonVolatileMode, MicrochipPotentiometerBase._INITIALVALUE_LOADED_FROM_EEPROM);
    }
