...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4661.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4661 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4661 class wit the I2C device that
     * is the connection to the MCP4661, whether the address pin A0 is high or
