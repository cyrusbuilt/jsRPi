...
/**
 * @classdesc Hardware device abstraction component for the Microchip MCP4441.
 * @extends {MicrochipPotentiometerBase}
 */
class MCP4441 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4441 class wit the I2C device that
     * is the connection to the MCP4441, whether the address pin A0 is high or
