...
var MomentarySwitchBase = require('./MomentarySwitchBase.js');
...
function MomentarySwitchComponent(pin) {
  	...
  	var self = this;
  	var _base = new MomentarySwitchBase();
	var _pin = pin;
...
inherits(MomentarySwitchComponent, MomentarySwitchBase);
