...
const MomentarySwitchBase = require('./MomentarySwitchBase.js');
...
*/
class MomentarySwitchComponent extends MomentarySwitchBase {
  /**
   * Initializes a new instance of the jsrpi.Components.Switches.MomentarySwitchComponent
   * class with the pint the switch is attached to.
