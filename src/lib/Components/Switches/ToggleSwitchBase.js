...
const ToggleSwitch = require('./ToggleSwitch.js');
...
* @extends {SwitchBase}
* @implements {ToggleSwitch}
*/
class ToggleSwitchBase extends ToggleSwitch {
  /**
   * Initializes a new instance of the jsrpi.Commponents.Switches.ToggleSwitchBase
   * class.
   * @constructor
   */
  constructor() {
