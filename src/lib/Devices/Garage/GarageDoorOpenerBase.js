...
const GarageDoorOpener = require('./GarageDoorOpener.js');
...
*/
class GarageDoorOpenerBase extends GarageDoorOpener {
  /**
   * Initializes a new instance of the jsrpi.Devices.Garage.GarageDoorOpenerBase
  ...
  */
  on(evt, callback) {
    if (this.isDisposed) {
      throw new ObjectDisposedException("GarageDoorOpenerBase");
    }
  ...
  * @property {OpenerState} state - The garage door state.
  * @override
  */
  get state() {
  ...
  * @property {Boolean} isOpen - true if the garage door is open; Otherwise,
  * false.
  * @readonly
  * @override
  */
