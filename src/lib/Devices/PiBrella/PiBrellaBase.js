...
var ButtonComponent = require('../../Components/Button/Button.js');
var BuzzerComponent = require('../../Components/Buzzers/Buzzer.js');
...
module.exports = extend(true, PiBrellaBase, DeviceBase);
