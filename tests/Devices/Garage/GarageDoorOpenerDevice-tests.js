...
var GarageDoorOpener = require('../../../src/lib/Devices/Garage/GarageDoorOpener');
var GarageDoorOpenerDevice = require('../../../src/lib/Devices/Garage/GarageDoorOpenerDevice');
...
function createGarageDoorOpener() {
...
module.exports.GarageDoorOpenerDeviceTests = {
	disposeAndIsDisposedTest: function(assert) {
		var fakeOpener = createGarageDoorOpener();
